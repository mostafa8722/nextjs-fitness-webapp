...
import TestimonyCard from "../cards/testimoniesCard";
...
const TestimonyContainerEl = styled("section")<{isMobile:boolean,isTablet:boolean}>(({isMobile,isTablet})=>`
 display:flex;
...
const TestimoniesContainer = ()=>{
    ...
    return (
        <TestimonyContainerEl isMobile={isMobile} isTablet={isTablet} >
               <Heading title="Our Testimonies" />
 ...
 {list.map((item:any,index:number)=>  <TestimonyCard  key={index} {...item}/>)}
